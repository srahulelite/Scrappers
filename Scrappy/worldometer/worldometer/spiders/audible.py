...
class AudibleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if(next_page_url):
            yield response.follow(url=next_page_url, callback=self.parse, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36'})
